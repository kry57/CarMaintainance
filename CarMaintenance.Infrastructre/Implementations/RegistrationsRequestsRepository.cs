...
{
    public class RegistrationsRequestsRepository(ApplicationDbContext context, IMapper mapper, ICurrentUserService currentUserService) : IRegistrationRequestsRepository
    {
